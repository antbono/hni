...
: rclcpp::Node("chat_action_client_node", options)
{
  ...
  this->client_ptr_ =
    rclcpp_action::create_client<hni_interfaces::action::ChatPlay>(this, "chat_play");

  this->timer_ = this->create_wall_timer(
    std::chrono::milliseconds(500), std::bind(&ChatActionClient::sendAsyncGoal, this));
...
void ChatActionClient::sendAsyncGoal()
{
  ...
  auto send_goal_options =
    rclcpp_action::Client<hni_interfaces::action::ChatPlay>::SendGoalOptions();
