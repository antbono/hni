  ...
  , kHorResolution_(640)
{
  ...
  this->timer_ =
      this->create_wall_timer(std::chrono::milliseconds(500), std::bind(&HeadTrackActionServer2::sendGoal, this));
  ...
  //                        "face_tracker/_action/feedback", 10, std::bind(&HeadTrackActionServer2::obj_pos_callback,
  //                        this, _1));
}
...
void HeadTrackActionServer2::sendGoal()
{
  ...
  send_goal_options.goal_response_callback = std::bind(&HeadTrackActionServer2::goalResponseCallback, this, _1);

  send_goal_options.feedback_callback = std::bind(&HeadTrackActionServer2::feedbackCallback, this, _1, _2);

  send_goal_options.result_callback = std::bind(&HeadTrackActionServer2::resultCallback, this, _1);
...
void HeadTrackActionServer2::goalResponseCallback(const GoalHandleObjTrack::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void HeadTrackActionServer2::feedbackCallback(GoalHandleObjTrack::SharedPtr,
...
rclcpp_action::GoalResponse HeadTrackActionServer2::handleGoal(const rclcpp_action::GoalUUID& uuid,
...
HeadTrackActionServer2::handleCancel(const std::shared_ptr<GoalHandleHeadTrack> goal_handle)
{
