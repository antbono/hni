...
#include "hni_cpp/head_track_action_server2.hpp"



namespace hni_head_track_action_server2 {

HeadTrackActionServer2::HeadTrackActionServer2(const rclcpp::NodeOptions & options)
  : rclcpp::Node("head_track_action_server2_node", options),
  ...
  this->client_ptr_ = rclcpp_action::create_client<hni_interfaces::action::VideoTracker>(
                        this,
                        "face_tracker");
  ...
  this->action_server_ = rclcpp_action::create_server<HeadTrack>(
                           this,
                           "head_track",
                           std::bind(&HeadTrackActionServer2::handleGoal, this, _1, _2),
                           std::bind(&HeadTrackActionServer2::handleCancel, this, _1),
                           std::bind(&HeadTrackActionServer2::handleAccepted, this, _1));

  std::vector<float> c0   = {0.0, 0.0}; head_pos_[c0] = "c0";

  std::vector<float> u1   = { 0.0,   -0.25 }; head_pos_[u1] = "u1";
  std::vector<float> u2   = { 0.0,   -0.50 }; head_pos_[u2] = "u2";

  std::vector<float> d1   = { 0.0,   +0.25 }; head_pos_[d1] = "d1";
  std::vector<float> d2   = { 0.0,   +0.50 }; head_pos_[d2] = "d2";

  std::vector<float> l1   = { +0.36,  0.0 }; head_pos_[l1] = "l1";
  std::vector<float> l2   = { +0.72,  0.0 }; head_pos_[l2] = "l2";
  std::vector<float> l3   = { +1.08,  0.0 }; head_pos_[l3] = "l3";

  std::vector<float> r1   = { -0.36,  0.0 }; head_pos_[r1] = "r1";
  std::vector<float> r2   = { -0.72,  0.0 }; head_pos_[r2] = "r2";
  std::vector<float> r3   = { -1.08,  0.0 }; head_pos_[r3] = "r3";

  std::vector<float> u1r1 = { -0.36, -0.25 }; head_pos_[u1r1] = "u1r1";
  std::vector<float> u1r2 = { -0.72, -0.25 }; head_pos_[u1r2] = "u1r2";
  std::vector<float> u1r3 = { -1.08, -0.25 }; head_pos_[u1r3] = "u1r3";
  std::vector<float> u2r1 = { -0.36, -0.50 }; head_pos_[u2r1] = "u2r1";
  std::vector<float> u2r2 = { -0.72, -0.50 }; head_pos_[u2r1] = "u2r2";
  std::vector<float> u2r3 = { -1.08, -0.50 }; head_pos_[u2r3] = "u2r3";

  std::vector<float> u1l1 = { +0.36, -0.25 }; head_pos_[u1l1] = "u1l1";
  std::vector<float> u1l2 = { +0.72, -0.25 }; head_pos_[u1l2] = "u1l2";
  std::vector<float> u1l3 = { +1.08, -0.25 }; head_pos_[u1l3] = "u1l3";
  std::vector<float> u2l1 = { +0.36, -0.50 }; head_pos_[u2l1] = "u2l1";
  std::vector<float> u2l2 = { +0.72, -0.50 }; head_pos_[u2l2] = "u2l2";
  std::vector<float> u2l3 = { +1.08, -0.50 }; head_pos_[u2l3] = "u2l3";

  std::vector<float> d1l1 = { +0.36, +0.25 }; head_pos_[d1l1] = "d1l1";
  std::vector<float> d1l2 = { +0.72, +0.25 }; head_pos_[d1l2] = "d1l2";
  std::vector<float> d1l3 = { +1.08, +0.25 }; head_pos_[d1l3] = "d1l3";
  std::vector<float> d2l1 = { +0.36, +0.50 }; head_pos_[d2l1] = "d2l1";
  std::vector<float> d2l2 = { +0.72, +0.50 }; head_pos_[d2l2] = "d2l2";
  std::vector<float> d2l3 = { +1.08, +0.50 }; head_pos_[d2l3] = "d2l3";

  std::vector<float> d1r1 = { -0.36, +0.25 }; head_pos_[d1r1] = "d1r1";
  std::vector<float> d1r2 = { -0.72, +0.25 }; head_pos_[d1r2] = "d1r2";
  std::vector<float> d1r3 = { -1.08, +0.25 }; head_pos_[d1r3] = "d1r3";
  std::vector<float> d2r1 = { -0.36, +0.50 }; head_pos_[d2r1] = "d2r1";
  std::vector<float> d2r2 = { -0.72, +0.50 }; head_pos_[d2r2] = "d2r2";
  std::vector<float> d2r3 = { -1.08, +0.50 }; head_pos_[d2r3] = "d2r3";


  RCLCPP_INFO(this->get_logger(), "HeadTrackActionServer2 Initialized");

  //this->play_cmd_sub_ = this->create_subscription<hni_interfaces::msg::Pos2D>(
  //                "face_pos_topic", 10, std::bind(&HeadTrackActionServer2::face_pos_callback, this, _1));

  //this->obj_pos_sub_ = this->create_subscription<hni_interfaces::action::VideoTracker_FeedbackMessage>(
  //                       "face_tracker/_action/feedback", 10, std::bind(&HeadTrackActionServer2::obj_pos_callback, this, _1));

}

HeadTrackActionServer2::~HeadTrackActionServer2() {}
...
void HeadTrackActionServer2::sendGoal()  {
  using namespace std::placeholders;
  ...
  send_goal_options.goal_response_callback =
    std::bind(&HeadTrackActionServer2::goalResponseCallback, this, _1);

  send_goal_options.feedback_callback =
    std::bind(&HeadTrackActionServer2::feedbackCallback, this, _1, _2);

  send_goal_options.result_callback =
    std::bind(&HeadTrackActionServer2::resultCallback, this, _1);
...
void HeadTrackActionServer2::goalResponseCallback(
...
void HeadTrackActionServer2::feedbackCallback(
...
void HeadTrackActionServer2::resultCallback(const GoalHandleObjTrack::WrappedResult & result) {
  switch (result.code) {
...
rclcpp_action::GoalResponse HeadTrackActionServer2::handleGoal(
...
rclcpp_action::CancelResponse HeadTrackActionServer2::handleCancel(
...
void HeadTrackActionServer2::handleAccepted(const std::shared_ptr<GoalHandleHeadTrack> goal_handle) {
  using namespace std::placeholders;
  // this needs to return quickly to avoid blocking the executor, so spin up a new thread
  std::thread{std::bind(&HeadTrackActionServer2::execute, this, _1), goal_handle} .detach();
}

void HeadTrackActionServer2::execute(const std::shared_ptr<GoalHandleHeadTrack> goal_handle) {
...
RCLCPP_COMPONENTS_REGISTER_NODE(hni_head_track_action_server2::HeadTrackActionServer2)