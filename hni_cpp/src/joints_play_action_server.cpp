...
uint8_t rec_joint_indexes_[10] = { joint_indexes_msg_.LSHOULDERPITCH, joint_indexes_msg_.LSHOULDERROLL,
...
rclcpp_action::GoalResponse JointsPlayActionServer::handleGoal(const rclcpp_action::GoalUUID& uuid,
...
JointsPlayActionServer::handleCancel(const std::shared_ptr<GoalHandleJointsPlay> goal_handle)
{
